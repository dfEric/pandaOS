...
Kernel method 核方法 
Kernel trick 核技巧 
Kernelized Linear Discriminant Analysi KLDA 核线性判别分析 
...
convex 凸的 
contours 轮廓 
coordinate ascent 同等级上升 
covariance 协方差 
canonical 正规的，正则的 
concave 非凸的 
corresponds 相符合；相当；通信 
corollary 推论 
concrete 具体的事物，实在的东西 
cross validation 交叉验证 
convention 约定 
centroids 质心，形心 
converge 收敛 
...
forgo 摒弃，放弃 
frequentist 最常发生的 
forward search 前向式搜索 
formalize 使定形

G

generalized 归纳的 
generalization 概括，归纳；普遍化；判断（根据不足） 
guarantee 保证；抵押品 
geometric margins 几何边界 
generative 生产的；有生产力的

H

heuristic 启发式的；启发法；启发程序 
hone 怀恋；磨 
hyperplane 超平面
...
joint distribution 联合概率

L

lieu 替代 
logarithmic 对数的，用对数表示的 
latent 潜在的 
...
minor 较小的，次要的 
multinomial 多项的 
multi-class classification 二分类问题
...
regularization 使系统化；调整 
reoptimize 重新优化 
restrict 限制；限定；约束 
reminiscent 回忆往事的；提醒的；使人联想…的（of） 
remark 注意 
...
spurious 假的；伪造的 
subtract 减去；减法器 
simultaneously 同时发生地；同步地 
suffice 满足 
scarce 稀有的，难得的 
split 分解，分离 
subset 子集 
statistic 统计量 
successive iteratious 连续的迭代 
scale 标度 
sort of 有几分的 
squares 平方
...
wrapper 包装
      valid implement智能算法解决系统远程控制指令，读，写，修改，删除，复制，粘贴，非手机系统本人本地写入修改添加执行的任何文件数据及代码或指令符
    // Your code here...
})();
